...
if age:
    ...
    elif mode == 904: txxx.Main()
    elif mode == 905: txxx.List(url)
    elif mode == 906: txxx.Categories(url)
    elif mode == 907: txxx.Playvid(url, name, download)
    elif mode == 908: txxx.Search(url, keyword)
